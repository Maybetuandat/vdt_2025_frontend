pipeline {
    ...
    environment {
        IMAGE_NAME = 'maybetuandat/vdt_fe'
        DOCKER_HUB_CREDENTIALS = 'dockerhub_credential'
        GITHUB_CREDENTIALS = 'github_token' 
        CONFIG_REPO_URL = 'https://github.com/maybetuandat/vdt_2025_frontend_config.git' 
    }
    ...
    stages {
        ...
        stage('Checkout Source Code') {
            steps {
                echo " Cloning frontend source code..."
                checkout scm
    ...
    post {
        ...
        success {
            ...
            echo " Docker Hub: https://hub.docker.com/r/maybetuandat/vdt_fe"
